...
# Set visual editor to nvim
export VISUAL='nvim'

# Bind v to edit-command-line in vicmd mode
...
# alias for working with kubernetes within neovim
# ref: https://github.com/Ramilito/kubectl.nvim
alias k8s='nvim +"lua require(\"kubectl\").open()"'

# Override neovide to default into fork (spawn a child process)
